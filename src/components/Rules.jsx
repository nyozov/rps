...
function Rules() {
  ...
  return (
    <div >
      ...
      {modalOpen && (
        <div className="bg-[rgba(0,0,0,0.4)] w-screen h-screen absolute top-0 left-0">
        <div className=" rounded-lg mt-12 absolute p-12 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[rgba(255,255,255,0.97)]">
